...
class LiveVideoTrayItem extends Component {
  ...
  render() {
    ...
    return (
      <div ref="TrayItemContainer" style={isUserProfile ? styles.trayItemUser : styles.trayItemContainer} onClick={() => setCurrentStoryObject('LIVE', {broadcast: this.props.liveItem})}>
